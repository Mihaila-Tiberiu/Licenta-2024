                ...
                <div>
                    ...
                    <div className="w-2/4 mx-auto">
                        ...
                        {locations.length > 0 && locations.map(location => (
                            <div>
                                <Link to={'/account/places/'+location.IdLocatie} key={location.IdLocatie} className="bg-gray-200 p-4 rounded-2xl flex gap-4 mt-4 cursor-pointer border-2 border-gray-300 shadow-lg" title="Apasă pentru a edita">
                                ...
                                <button className="mr-3/4 bg-transparent border-none">
                                    <div title="Șterge locația">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 cursor-pointer bg-gray-200 rounded p-1 tooltip hover:text-white hover:bg-red-700" onClick={() => handleDeleteLocation(location.IdLocatie)} title="Delete photo">
