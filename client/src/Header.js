        ...
        <div className="container mx-auto flex">
          ...
          <ul className="flex space-x-4 mx-auto">
            <div className="flex rounded items-center text-lg">
                ...
                <li><a href="#" className="hover:text-gray-300 border-r-2 ml-2 pr-2">Locații</a></li>
            ...
            <div className='w-1/4 text-right text-lg'>
                <div className='flex justify-end '>
                    ...
                    {user && (
                      <div className='flex hover:text-gray-300 hover:border-gray-300'>
                        <div className='mr-2'>
                          {user.Username}
                        </div>
                        <div className='rounded-full border-2 border-white p-1 hover:text-gray-300 hover:border-gray-300'>
